...
client = Client(api_key="AIzaSyCuu_Sw_7Isdwyydopnc8v7LFc7hGCLnrM") 
print("Client initialized")




# Definição agnóstica dos campos (Nome do campo e sua descrição)
campos_a_extrair = [
    {"campo": "nome", "descricao": "Nome do profissional, normalmente no canto superior esquerdo da imagem"},
    {"campo": "inscricao", "descricao": "Número de inscrição do profissional"},
    {"campo": "seccional", "descricao": "Seccional do profissional"},
    {"campo": "subsecao", "descricao": "Subseção à qual o profissional faz parte."},
    {"campo": "categoria", "descricao": "Categoria, pode ser ADVOGADO, ADVOGADA, SUPLEMENTAR, ESTAGIARIO, ESTAGIARIA"},
    {"campo": "endereco_profissional", "descricao": "Endereço do profissional"},
    {"campo": "telefone_profissional", "descricao": "Telefone do profissional."},
    {"campo": "situacao", "descricao": "Situação do profissional, normalmente no canto inferior direito"}
]
